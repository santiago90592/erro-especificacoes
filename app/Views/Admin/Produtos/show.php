     ...
     <div class="card-body">
      ...
      <div class="mt-4">
        ...
        <?php if($produto->deletado_em == null) : ?>
          ...
          <a href="<?php echo site_url("admin/produtos/extras/$produto->id"); ?>" class="btn btn-info btn-sm mr-2">
            <i class="mdi mdi-plus btn-icon-prepend"></i>
            Extras
          </a>

          <a href="<?php echo site_url("admin/produtos/especificacoes/$produto->id"); ?>" class="btn btn-info btn-sm mr-2">
            <i class="mdi mdi-custom btn-icon-prepend"></i>
            Especificações
          </a>
